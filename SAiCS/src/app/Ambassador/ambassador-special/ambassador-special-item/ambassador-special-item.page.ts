...
@Component({
  selector: 'app-ambassador-special-item',
  templateUrl: './ambassador-special-item.page.html',
  styleUrls: ['./ambassador-special-item.page.scss'],
})
export class AmbassadorSpecialItemPage implements OnInit {
  Item: any;
  ItemFeedback: any = [];
  ItemId: any;
  ItemQuantity = 0;
