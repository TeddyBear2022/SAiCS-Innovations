...
export class SendEmailService {
  ...
  ClientOrderConfirmation(Client: string, EmailTo: string, Delivery: any, OrderNum: any, ShippingCost: any)
  {
    let Body: string = "";
...
.es-p-all-default {
                                                                    ...
                                                                    <tr>
                                                                        <td width="530" class="esd-container-frame" align="center" valign="top">
                                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img class="adapt-img" src="https://demo.stripocdn.email/content/guids/90574bc9-513e-4931-bc42-741108425b2d/images/saicslogo_yS7.jpg" alt="image" style="display: block;" width="198" /></a></td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        </td>
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-p15t es-p20b" align="left">
                                                                                            <p style="font-size: 16px; color: #777777;">Dear ${Client}! Your Order was placed successfully and will be proceesed soon.</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                                        ...
                                                                                        this.items.forEach(o => {
                                                                                                 Body +=  `<tr>
                                                                                                        ...
                                                                                                        <td style="padding: 5px 0" width="20%" align="left">
                                                                                                            <p>${this.cp.transform(o.quantity * o.price, 'ZAR', 'symbol-narrow')}</p>
                                                                                                        </td>
                                                                                                    </tr>`;
                                                                                                })
                                                                                                    Body +=`<tr>
                                                                                                        ...
                                                                                                        <td style="padding: 5px 0" width="20%" align="left">
                                                                                                            <p>${this.cp.transform(ShippingCost, 'ZAR', 'symbol-narrow')}</p>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                            ...
                                                                                            <table style="width: 500px;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td width="20%">
                                                                                                            <h4>${this.cp.transform(this.OdrSmry.totalCost, 'ZAR', 'symbol-narrow')}</h4>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
    ...
    console.dirxml(xmlstr);
    
   //this.api.OrderEmail(EmailTo, Body, "Order Confirmation").subscribe(res => {console.log(res);
   //})
  }

  AmbassadorOrderNotification(EmailTo: string, OrderItems: any,  Subject: string)
  {

  }

  ClientOrderStatusUpdate(EmailTo: string, Body: string,  Subject: string)
  {
